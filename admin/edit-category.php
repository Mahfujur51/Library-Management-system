...
if(strlen($_SESSION['alogin'])==0)
{
    ...
    if(isset($_POST['update']))
    {
        ...
        $sql="UPDATE tbl_catagory SET catname='$catname',status='$status' WHERE id='$id'";
                                    ...
                                    if ($num>0) {
                                        while ($result=mysqli_fetch_array($query)) {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="catname" value="<?php echo htmlentities($result['catname']);?>" required />
                                            </div>
                                            <div class="form-group">
                                                <label>Status</label>
